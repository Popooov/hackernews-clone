...
const Nav = ({ toggleTheme }) => {
    ...
    const base = `nav-link nav-link-${theme}`
            ...
            <ul className='nav-flex'>
                <li>
                    <NavLink
                        ...
                        className={({ isActive }) => `${base}${isActive ? ' nav-link-active' : ''}`}
                ...
                <input type="checkbox" onChange={toggleTheme} />
                {
                    theme === 'light'
                        ...
                        <span className='slider round'>
                            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" viewBox="0 0 24 24" className={`switch-${theme} switch-sun`}>
                        ...
                        :
                        <span className='slider round'>
                            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" viewBox="0 0 24 24" className={`switch-${theme} switch-moon`}>
